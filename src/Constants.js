...
export const POINTER_STATE_PRISTINE   = Symbol('POINTER_STATE_PRISTINE');
export const POINTER_STATE_EXTENDING  = Symbol('POINTER_STATE_EXTENDING');
export const POINTER_STATE_MOVING     = Symbol('POINTER_STATE_MOVING');
